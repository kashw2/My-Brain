Bloom filters are probabilistic [[Data Structures|Data Structures]] that present a way to quickly and efficiently determine if a value definitely does not exist or it it may exist in a record set.
